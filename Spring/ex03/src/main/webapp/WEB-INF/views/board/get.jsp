...
$(document).ready(function() {
	...
	$.getJSON("/board/getAttachList",{bno:bno}, function(arr){
		...
		$(arr).each(function(i, attach){
			if(attach.filetype){
				...
				str += "<li data-path='"+attach.uploadPath+"' data-uuid='"+attach.uuid+"' data-filename='"+attach.fileName+"' data-fileType='"+attach.filetype+"'><div>";
	...
	function  showImage(fileCallPath){
		...
		.animation({width:'100%', height:'100%'},1000);
	}
