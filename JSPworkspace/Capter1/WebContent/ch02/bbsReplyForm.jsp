...
<c:set var="heads">답변, 정보, 질문, 기타</c:set>
	...
	<form name="upForm" method="post" class="form" enctype="multipart/form-data" action="bbsInsert">
		<input type="hidden" name="ridx" value="${BBSItem.idx }">
		...
		<div class="row rowLine">
			...
			<div class="${cssright }">
				<input type="text" class="form-control" name="title" placeholder="(필수)제목" value="${BBSItem.title }">
			</div>
		</div> 
		...
		<div class="row rowLine">
			...
			<div class="${cssright }">
				<input type="text" class="form-control" name="writer" ${writerReadOnly } value="${sessionScope.sessName }" placeholder="(필수)작성자">
			</div>
		</div> 
		...
		<div class="row rowLine" style="display:${displayMark};">
			<div class="${cssleft }">내용</div>
			<div class="${cssright }">
				<textarea class="form-control" id="html" rows="10" name="html" >${BBSItem.html }</textarea>
			</div>
		</div>
		...
		<div class="row rowLine" style="display:none;">
			<div class="${cssleft }">내용</div>
			<div class="${cssright }">
				<textarea class="form-control" id="html2" rows="10" name="html2" >${BBSItem.html2 }</textarea>
			</div>
		</div>
		
		<div class="row rowLine">
			<div class="col-md-12"><span class="glyphicon glyphicon-paperclip"></span>1</div>
			<input class="form-control" type="file" name="upfile1" placeholder="첨부파일1">
		</div>
		
		<div class="row rowLine">
			<div class="col-md-12"><span class="glyphicon glyphicon-paperclip"></span>2</div>
			<input class="form-control" type="file" name="upfile2" placeholder="첨부파일2">
		</div>
