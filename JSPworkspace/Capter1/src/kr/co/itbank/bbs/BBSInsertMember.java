...
@WebServlet("/BBSInsertMember")
public class BBSInsertMember extends HttpServlet {
	...
	private String result = "회원 분류 등록 success";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			sql = "insert into leveltable (title, level, useflag, isadmin, isdev) values (?, ?, ?, ?, ?)";
			...
			System.out.println("[BBSInsertMember] PSTMT = "+pstmt);
			
		}catch(Exception e){
			System.out.println("[BBSInsertMember] Error : "+e.getMessage());
