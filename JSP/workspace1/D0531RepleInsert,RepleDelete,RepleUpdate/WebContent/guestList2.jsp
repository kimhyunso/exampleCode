...
%>
  <tr onmouseOver="this.style.backgroundColor='lightgray'" onmouseOut="this.style.backgroundColor=''">
    ...
    <td> <a href="guestDetail.jsp?Gidx=<%=sabun%>"> <% out.print(title+"&nbsp"+ "<font color=red>["+position+"]</font>"); %> </a> </td> 
 ...
 <tr align="center">
  ...
  <tr align="center">
   ...
   <form action="guestList.jsp" name="myform">
       ...
       <input type="button" value="guest" onclick="location.href='guestlist.jsp'">
    </form>
   </td>
  </tr>
 </table>
