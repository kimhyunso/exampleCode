...
<script type="text/javascript">
	...
	function registerFunction() {
		xhr.open("post",
				"ReplyRegisterServlet.do?br_writer="
...
<body>
	<%
		...
		UserDTO user = userDAO.getUser(no);
	...
	<div class="mx-auto" style="width: 1000px;">
		...
		<div class="my-3 p-3 bg-white rounded shadow-sm">			
			<%
				...
				ArrayList<ReplyDTO> replyList = replyDAO.getList(user.getSabun());
