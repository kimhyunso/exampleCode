...
<body>
 ...
 <table  width=750 border=1 cellspacing=0 align="center">
   <form action="loginprocess.do">
     <tr>
	  <td width="450"> <img src="resources/images/pen1.gif">userid:<img src="resources/images/pen1.gif"> </td>
	...
	<tr>
	  <td> <img src="resources/images/pen1.gif">userpw:<img src="resources/images/pen1.gif"> </td>
